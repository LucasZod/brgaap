...
const TopBar = ({ children }: { children: React.ReactNode }) => (
  <header className="border-b border-hairline flex items-center relative">
    {children}
  </header>
);
...
const TopBarInner = ({ children }: { children: React.ReactNode }) => (
  <div className="mx-auto w-full max-w-[680px] px-6 py-5 text-center">
    {children}
  </div>
);
...
const MdHeading = ({ children }: { children: React.ReactNode }) => (
  <h2 className="mb-2 mt-6 font-serif text-xl font-semibold text-ink first:mt-0">
    {children}
  </h2>
);

const MdSubheading = ({ children }: { children: React.ReactNode }) => (
  <h3 className="mb-1.5 mt-5 font-serif text-lg font-semibold text-ink first:mt-0">
    {children}
  </h3>
);
...
const MdList = ({ children }: { children: React.ReactNode }) => (
  <ul className="mb-4 flex list-disc flex-col gap-1.5 pl-5 last:mb-0">
    {children}
  </ul>
);

const MdOrderedList = ({ children }: { children: React.ReactNode }) => (
  <ol className="mb-4 flex list-decimal flex-col gap-1.5 pl-5 last:mb-0">
    {children}
  </ol>
);
...
const MdLink = ({
  ...
  <a
    href={href}
    className="underline decoration-focus underline-offset-2 hover:text-ink-soft"
  >
    {children}
  </a>
);
